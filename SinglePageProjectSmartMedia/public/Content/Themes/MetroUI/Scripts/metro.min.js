...
$(function () { $(window).on("resize", function () { if (METRO_DIALOG) { var c = ($(window).height() - METRO_DIALOG.outerHeight()) / 2, a = ($(window).width() - METRO_DIALOG.outerWidth()) / 2; METRO_DIALOG.css({ top: c, left: a }) } }) }); (function (c) {
    c.Metro.currentLocale = "en"; c.Metro.currentLocale = void 0 != METRO_LOCALE?METRO_LOCALE:"en"; c.Metro.Locale = {
        ...
        pt: { months: "Janeiro Fevereiro Mar\u00e7o Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro Jan Fev Mar Abr Mai Jun Jul Ago Set Out Nov Dez".split(" "), days: "Domingo Segunda-feira Ter\u00e7a-feira Quarta-feira Quinta-feira Sexta-feira Sabado Dom Seg Ter Qua Qui Sex Sab".split(" "), buttons: "Hoje Limpar Cancelar Ajuda Anterior Seguinte Terminar".split(" ") }, pl: {
            ...
            days: "Niedziela Poniedzia\u0142ek Wtorek \u015aroda Czwartek Pi\u0105tek Sobota Nd Pon Wt \u015ar Czw Pt Sob".split(" "), buttons: "Dzisiaj Wyczy\u015b\u0107 Anuluj Pomoc Poprzedni Nast\u0119pny Koniec".split(" ")
        }, cs: {
            months: "Leden \u00danor B\u0159ezen Duben Kv\u011bten \u010cerven \u010cervenec Srpen Z\u00e1\u0159\u00ed \u0158\u00edjen Listopad Prosinec Led \u00dan B\u0159 Dub Kv\u011b \u010ce \u010cer Srp Z\u00e1 \u0158\u00ed Li Pro".split(" "), days: "Ned\u011ble Pond\u011bl\u00ed \u00dater\u00fd St\u0159eda \u010ctvrtek P\u00e1tek Sobota Ne Po \u00dat St \u010ct P\u00e1 So".split(" "),
...
this.options._calendar.slideDown("fast")):"fade" == this.options.effect?(c(".calendar-dropdown").fadeOut("fast"), this.options._calendar.fadeIn("fast")):(c(".calendar-dropdown").hide(), this.options._calendar.show())
    ...
    c.widget("metro.carousel", {
        version: "1.0.0", options: { auto: !0, period: 2E3, duration: 500, effect: "slowdown", direction: "left", markers: { show: !0, type: "default", position: "left" }, controls: !0, stop: !0, width: "100%", height: 300 }, _slides: {}, _currentIndex: 0, _interval: 0, _outPosition: 0, _create: function () {
            var a = this, b = this.options, d = carousel = this.element, c = carousel.find(".controls"); void 0 != d.data("auto") && (b.auto = d.data("auto")); void 0 != d.data("period") && (b.period = d.data("period")); void 0 != d.data("duration") &&
(b.duration = d.data("duration")); void 0 != d.data("effect") && (b.effect = d.data("effect")); void 0 != d.data("direction") && (b.direction = d.data("direction")); void 0 != d.data("width") && (b.width = d.data("width")); void 0 != d.data("height") && (b.height = d.data("height")); void 0 != d.data("stop") && (b.stop = d.data("stop")); void 0 != d.data("controls") && (b.controls = d.data("controls")); void 0 != d.data("markersShow") && (b.markers.show = d.data("markersShow")); void 0 != d.data("markersType") && (b.markers.type = d.data("markersType"));
            void 0 != d.data("markersPosition") && (b.markers.position = d.data("markersPosition")); carousel.css({ width: this.options.width, height: this.options.height }); this._slides = carousel.find(".slide"); if (!(1 >= this._slides.length)) {
...
c.hide(); if (this.options.stop) carousel.on("mouseenter", function () { clearInterval(a._interval) }).on("mouseleave", function () { a.options.auto && (a._autoStart(), a.options.period) }); this.options.auto && this._autoStart()
            }
...
(this._currentIndex = this._slides.length - 1), this._outPosition = this.element.width()):"next" === a && (this._currentIndex += 1, this._currentIndex >= this._slides.length && (this._currentIndex = 0), this._outPosition = -this.element.width()); a = this._slides[this._currentIndex]; switch (this.options.effect) {case "switch": this._effectSwitch(b, a); break;case "slowdown": this._effectSlowdown(b, a, this.options.duration); break;case "fade": this._effectFade(b, a, this.options.duration); break;default: this._effectSlide(b, a, this.options.duration)} var d =
 this; this.element.find(".markers ul li a").each(function () { c(this).data("num") === d._currentIndex?c(this).parent().addClass("active"):c(this).parent().removeClass("active") })
            ...
            var b = this._slides[this._currentIndex], d = this._slides[a]; this._outPosition = a > this._currentIndex?-this.element.width():this.element.width(); switch (this.options.effect) {
                case "switch": this._effectSwitch(b, d); break;case "slowdown": this._effectSlowdown(b, d, this.options.duration); break;case "fade": this._effectFade(b,
d, this.options.duration); break;default: this._effectSlide(b, d, this.options.duration)} this._currentIndex = a
        }, _markers: function (a) {
...
d)
    ...
    c.widget("metro.countdown", {
        version: "1.0.0", options: { style: { background: "bg-dark", foreground: "fg-white", divider: "fg-dark" }, blink: !0, days: 1, stoptimer: 0, ontick: function (a, b, d, c) { }, onstop: function () { } }, wrappers: {}, _interval: 0, _create: function () {
            ...
            this._super("_setOption",
a, b)
        }, tick: function () { var a = this; this._interval = setInterval(function () { var b, d, c, f; b = Math.floor((a.options.stoptimer - new Date) / 1E3); 0 > b && (b = 0); d = Math.floor(b / 86400); a.updateDuo(0, 1, d); b -= 86400 * d; c = Math.floor(b / 3600); a.updateDuo(2, 3, c); b -= 3600 * c; f = Math.floor(b / 60); a.updateDuo(4, 5, f); b -= 60 * f; a.updateDuo(6, 7, b); a.options.ontick(d, c, f, b); a.blinkDivider(); 0 === d && (0 === c && 0 === f && 0 === b) && (a.options.onstop(), a.stopDigit(), a._trigger("alarm"), clearInterval(a._interval)) }, 1E3) }, blinkDivider: function () {
            this.options.blink &&
this.element.find(".divider").toggleClass("no-visible")
        }, stopDigit: function () { this.wrappers.each(function () { c(this).children(".digit").addClass("stop") }) }, updateDuo: function (a, b, d) { this.switchDigit(this.wrappers.eq(a), Math.floor(d / 10) % 10); this.switchDigit(this.wrappers.eq(b), d % 10) }, switchDigit: function (a, b) {
...
f.attr("title", d.hints[g]), g <= d.score - 1 && f.addClass("rated"), f.on("click", function () { d.click(c(this).data("value"), a) }), f.appendTo(e); e.appendTo(b); d.showScore?(c("<span/>").addClass("score-hint").html(d.scoreHint + d.score).appendTo(b), b.css("height", "auto")):b.find("ul").css("margin-bottom", 0)
    ...
    c.widget("metro.slider", {
        version: "1.0.2", options: { position: 0, accuracy: 0, color: "default", completeColor: "default", markerColor: "default", colors: [], showHint: !1, change: function (a, b) { }, changed: function (a, b) { }, min: 0, max: 100, animate: !0, _slider: { vertical: !1, offset: 0, length: 0, marker: 0, ppp: 0, start: 0, stop: 0 } }, _create: function () {
            var a = this, b = this.element, d = this.options, c = this.options._slider; void 0 != b.data("accuracy") && (d.accuracy = 0 < b.data("accuracy")?b.data("accuracy"):0); void 0 != b.data("animate") &&
...
b.data("completeColor")); void 0 != b.data("markerColor") && (d.markerColor = b.data("markerColor")); void 0 != b.data("colors") && (d.colors = b.data("colors").split(",")); void 0 != b.data("showHint") && (d.showHint = b.data("showHint")); c.vertical = b.hasClass("vertical"); this._createSlider(); this._initPoints(); this._placeMarker(d.position); addTouchEvents(b[0]); b.children(".marker").on("mousedown", function (b) { b.preventDefault(); a._startMoveMarker(b) }); b.on("mousedown", function (b) { b.preventDefault(); a._startMoveMarker(b) })
        ...
        _startMoveMarker: function (a) { var b = this.element, d = this.options, e = this, f = b.children(".hint"); c(document).mousemove(function (a) { e._movingMarker(a); b.hasClass("permanent-hint") || f.css("display", "block") }); c(document).mouseup(function () { c(document).off("mousemove"); c(document).off("mouseup"); b.data("value", e.options.position); b.trigger("changed", e.options.position); d.changed(e.options.position, b); b.hasClass("permanent-hint") || f.css("display", "none") }); this._initPoints(); this._movingMarker(a) }, _movingMarker: function (a) {
            ...
            var b, d, c = this.options, f = 0, g = f = 0, h = this.element.children(".marker"), k = this.element.children(".complete"), l = this.element.children(".hint");
            d = this._percToPix(this.options.position); f = c.colors.length; g = c._slider.length / f; if (this.options._slider.vertical) {
...
2)
            } else b = this._percToPix(a), this._animate(h.css("left", d), { left: b }), this._animate(k.css("width", d), { width: b }), f && (f = Math.round(b / g) - 1, k.css("background-color", c.colors[0 > f?0:f])), c.showHint && this._animate(l.html(Math.round(a)).css("left", d - l.width() / 2), { left: b - l.width() / 2 })
        ...
        _correctValue: function (a) { var b = this.options.accuracy, d = this.options.max, c = this.options.min; if (0 === b) return a; if (a === d) return d; if (a === c) return c; a = Math.floor(a / b) * b + Math.round(a % b / b) * b; return a > d?d:a < c?c:a }, _initPoints: function () {
...
a; a = a < this.options.min?this.options.min:a; return "undefined" !== typeof a?(this._placeMarker(parseInt(a)), this.options.position = parseInt(a), this.options.change(Math.round(parseInt(a)), this.element), this):Math.round(this.options.position)
    ...
    c.widget("metro.times", {
        version: "1.0.0", options: { style: { background: "bg-dark", foreground: "fg-white", divider: "fg-dark" }, blink: !0, alarm: { h: 0, m: 0, s: 0 }, ontick: function (a, b, d) { }, onalarm: function () { } }, wrappers: {}, _interval: 0, _create: function () {
...
d.position?b.css({ top: a.offset().top - c(window).scrollTop() + a.outerHeight(), left: 2 == d.mode?a.offset().left + a.outerWidth() / 2 - b.outerWidth() / 2 - c(window).scrollLeft():a.offset().left - c(window).scrollLeft() }):"right" == d.position?b.css({ top: 2 == d.mode?a.offset().top + a.outerHeight() / 2 - b.outerHeight() / 2 - c(window).scrollTop() - 10:a.offset().top - 10 - c(window).scrollTop(), left: a.offset().left + a.outerWidth() + 15 - c(window).scrollLeft() }):"left" == d.position && b.css({
                top: 2 == d.mode?a.offset().top + a.outerHeight() / 2 - b.outerHeight() /
2 - c(window).scrollTop() - 10:a.offset().top - 10 - c(window).scrollTop(), left: a.offset().left - b.outerWidth() - 10 - c(window).scrollLeft()
            }); d._hint = b
        }, _destroy: function () { }, _setOption: function (a, b) { this._super("_setOption", a, b) }
    })
})(jQuery); (function (c) {
...
d.slideSleep, d.slideSpeed)
        }, slideToTime: function (a, b, d) { var c = this, f = this.element, g = f.find(".meter li.js-interval-" + a.replace(":", "-"))[0], h = f.find(".streams").outerWidth() + 2; setTimeout(function () { f.find(".events").animate({ scrollLeft: "+=" + (g.offsetLeft - h) }, d, function () { c._afterSlide() }) }, b); f.data("current-time", a) }, slideToGroup: function (a, b, d) {
            var c = this, f = this.element, g = f.find(".event-group"), h = f.find(".streams").outerWidth() + 2; setTimeout(function () {
                f.find(".events").animate({
                    scrollLeft: "+=" + (g[a -
1].offsetLeft - h)
                }, d, function () { c._afterSlide() })
            }, b)
...
b) {
            var d = this.element; this.options.width = "100%" == this.options.width?this.scrollbar.outerWidth():this.options.width; this.options.height = "100%" == this.options.height?this.scrollbar.outerHeight():this.options.height; this.scrollbar.css({ width: this.startSize.width, height: this.startSize.height }); this.contentWidth = a; this.contentHeight = b; "y" == this.options.axis?this.contentHeight > this.options.height?(this.scrollbar.css({ paddingRight: 20, paddingBottom: 0 }), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth =
...
this.scrollbar.css({ paddingRight: 0, paddingBottom: 0 })))
 ...
 []; a[a.length] = '<div class="scrollbar-h">'; a[a.length] = '<div class="scrollbar-h-up"></div>'; a[a.length] = '<div class="scrollbar-h-down"></div>'; a[a.length] = '<div class="scrollbar-line-h">'; a[a.length] = '<div class="scrollbar-line-h-btn"></div>'; a[a.length] = "</div>"; a[a.length] = "</div>"; a = a.join(""); this.scrollbar.append(a)
            } else this.scrollbar.find(".scrollbar-h").show(); var a = this.scrollbar.find(".scrollbar-line-h"), b = this.scrollbar.find(".scrollbar-line-h-btn"), d = this.scrollbar.find(".scrollbar-h");
...
b) {
            ...
            var d, c, f, g = this.options.wheel; if (void 0 !== b && (b.hasClass("scrollbar-h-up") || b.hasClass("scrollbar-h-down")) || "x" == this.options.axis || "x" != this.options.axis && "y" != this.options.axis && 1 > this.scrollbar.find(".scrollbar-v").length) {
                var h = 100 * (g / this.contentWidth); c = (this.options.width - 32) / 100 * h; h = parseInt(this.element.css("left")); f = isNaN(h)?0:Math.abs(h); h = this.scrollbar.find(".scrollbar-line-h-btn");
                d = this.scrollbar.find(".scrollbar-line-h"); var k = parseFloat(h.css("left")), k = isNaN(k)?0:k; 0 < a?(g = f - g, f = k - c):(g = f + g, f = k + c); 0 > g && (g = 0); g > this.contentWidth - this.options.width && (g = this.contentWidth - this.options.width); c = d.width(); d.height(); d = h.width(); h.height(); 0 > f && (f = 0); f + d > c && (f = c - d); this.element.css({ left: -1 * g }); h.css({ left: f })
...
d = this.scrollbar.find(".scrollbar-line-v"), k = parseFloat(h.css("top")), k = isNaN(k)?0:k, 0 < a?(g = f - g, c = k - c):(g = f + g, c = k + c), 0 > g && (g = 0), g > this.contentHeight - this.options.height && (g = this.contentHeight - this.options.height), d.width(), f = d.height(), h.width(), d = h.height(), 0 > c && (c = 0), c + d > f && (c = f - d), this.element.css({ top: -1 * g }), h.css({ top: c })
...
0, this.currCoords.x = null, this.currCoords.y = null)
    ...
    c.widget("metro.stepper", {
        version: "1.0.0", options: { steps: 3, start: 1, clickable: !0, onStep: function (a, b) { }, onStepClick: function (a, b) { } }, _create: function () { var a = this.element, b = this.options; void 0 != a.data("steps") && (b.steps = a.data("steps")); void 0 != a.data("start") && (b.start = a.data("start")); this._createStepper(); b.clickable && this._createEvents(); this._positioningSteps(); this._stepTo(b.start) }, _createEvents: function () {
            var a = this.element, b = this.options; a.on("click", "li", function (d) {
                d = c(this).data("step");
                b.onStepClick(d - 1, d); a.trigger("stepclick", d)
            })
        }, _createStepper: function () { var a = this.element, b = this.options, d, e; e = c("<ul/>"); for (d = 0; d < b.steps; d++) c("<li/>").data("step", d + 1).appendTo(e); e.appendTo(a) }, _positioningSteps: function () { var a = this.element, b = a.find("li"), d = a.width(), e = b.length - 1, f = c(b[0]).width(); c.each(b, function (a, b) { var k = 0 == a?0:(d - f) / e * a; c(b).animate({ left: k }) }) }, _stepTo: function (a) {
            var b = this.options, d = this.element.find("li"); d.removeClass("current").removeClass("complete"); c.each(d,
function (d, f) { d < a - 1 && c(f).addClass("complete"); d == a - 1 && (c(f).addClass("current"), b.onStep(d + 1, f)) })
        }, stepTo: function (a) { this._stepTo(a) }, first: function () { var a = this.options; a.start = 1; this._stepTo(a.start) }, last: function () { var a = this.options, b = this.element.find("li"); a.start = b.length; this._stepTo(a.start) }, next: function () { var a = this.options, b = this.element.find("li"); a.start + 1 > b.length || (a.start++, this._stepTo(a.start)) }, prior: function () { var a = this.options; 0 != a.start - 1 && (a.start--, this._stepTo(a.start)) },
        _destroy: function () { this._stepper.remove() }, _setOption: function (a, b) { this._super("_setOption", a, b) }
    })
...
$(window).resize(function () { 800 < (0 < window.innerWidth?window.innerWidth:screen.width)?$(".element-menu").show():$(".element-menu").hide() }); (function (c) {
    c.widget("metro.wizard", {
        version: "1.0.0", options: { stepper: !0, stepperType: "default", stepperClickable: !0, startPage: "default", locale: c.Metro.currentLocale, finishStep: "default", buttons: { cancel: !0, help: !0, prior: !0, next: !0, finish: !0 }, onCancel: function (a, b) { }, onHelp: function (a, b) { }, onPrior: function (a, b) { return !0 }, onNext: function (a, b) { return !0 }, onFinish: function (a, b) { }, onPage: function (a, b) { }, onStepClick: function (a) { } }, _stepper: void 0, _currentStep: 0, _steps: void 0, _create: function () {
            var a = this,
                b = this.element, c = this.options, e = b.find(".step"); this._steps = e; c.stepper && (this._stepper = this._createStepper(e.length).insertBefore(b.find(".steps")).stepper({ clickable: c.stepperClickable }).on("stepclick", function (b, e) { a.stepTo(e); c.onStepClick(e) })); void 0 != b.data("locale") && (c.locale = b.data("locale")); this._createEvents(); e = "default" != c.startPage && 1 < parseInt(c.startPage)?c.startPage:1; this.stepTo(e); this.options.onPage(this._currentStep + 1, b)
        }, _createStepper: function (a) {
            var b = this.options; a = c("<div/>").addClass("stepper").attr("data-role",
"stepper").attr("data-steps", a); "default" != b.stepperType && a.addClass(b.stepperType); return a
        }, _createEvents: function () {
            var a = this, b = this.element, d = this.options; if (d.buttons) {
                var e = c("<div/>").addClass("actions").appendTo(b), f = c("<div/>").addClass("group-left").appendTo(e), e = c("<div/>").addClass("group-right").appendTo(e), g; d.buttons.cancel && (g = c("<button type='button'/>").addClass("btn-cancel").html(c.Metro.Locale[d.locale].buttons[2]), "boolean" == typeof d.buttons.cancel?g.appendTo(f):(d.buttons.cancel.title &&
...
"left" != d.buttons.help.group?g.appendTo(e):g.appendTo(f)), g.on("click", function () { d.onHelp(a._currentStep + 1, b) })); d.buttons.prior && (g = c("<button type='button'/>").addClass("btn-prior").html(c.Metro.Locale[d.locale].buttons[4]), "boolean" == typeof d.buttons.prior?g.appendTo(e):(d.buttons.prior.title && g.html(d.buttons.prior.title), d.buttons.prior.cls && g.addClass(d.buttons.prior.cls), d.buttons.prior.group && "left" != d.buttons.prior.group?g.appendTo(e):g.appendTo(f)), g.on("click", function () {
...
"boolean" == typeof d.buttons.finish?g.appendTo(e):(d.buttons.finish.title && g.html(d.buttons.finish.title), d.buttons.finish.cls && g.addClass(d.buttons.finish.cls), d.buttons.finish.group && "left" != d.buttons.finish.group?g.appendTo(e):g.appendTo(f)), g.on("click", function () { d.onFinish(a._currentStep + 1, b) }))
            }
        }, next: function () {
            var a = this._currentStep + 1; if (a == this._steps.length) return !1; this._currentStep = a; this._steps.hide(); c(this._steps[a]).show(); this.options.onPage(this._currentStep + 1, this.element); void 0 !=
...
a.attr("href")
    ...
    c.widget("metro.popover", {
        version: "1.0.0", options: { popoverText: "", popoverTimeout: 3E3, popoverPosition: "top", popoverBackground: "bg-cyan", popoverColor: "fg-white", popoverMode: "none", popoverShadow: !0 }, popover: {}, _create: function () { this.createPopover() }, createPopover: function () {
            var a = this, b, d = this.options; b = this.element; c.each(b.data(), function (a, b) { try { d[a] = c.parseJSON(b) } catch (e) { d[a] = b } }); var e, f; e = c("<div/>").addClass("notice").appendTo("body").hide(); c("<div/>").appendTo(e); d.popoverShadow &&
...
function (b) { e.data("visible") || a.show() }); c(window).scroll(function () { a.popover.data("visible") && a.setPosition() })
        }, setPosition: function () {
            var a = this.options, b = this.popover, d = this.element; "top" == a.popoverPosition?b.css({ top: d.offset().top - c(window).scrollTop() - b.outerHeight() - 10, left: d.offset().left + d.outerWidth() / 2 - b.outerWidth() / 2 - c(window).scrollLeft() }):"bottom" == a.popoverPosition?b.css({
                top: d.offset().top - c(window).scrollTop() + d.outerHeight() + 10, left: d.offset().left + d.outerWidth() / 2 - b.outerWidth() /
2 - c(window).scrollLeft()
            }):"right" == a.popoverPosition?b.css({ top: d.offset().top + d.outerHeight() / 2 - b.outerHeight() / 2 - c(window).scrollTop(), left: d.offset().left + d.outerWidth() - c(window).scrollLeft() + 10 }):"left" == a.popoverPosition && b.css({ top: d.offset().top + d.outerHeight() / 2 - b.outerHeight() / 2 - c(window).scrollTop(), left: d.offset().left - b.outerWidth() - c(window).scrollLeft() - 10 }); return this
        }, setText: function (a) { this.popover.children("div").html(a) }, show: function () {
            var a = this.options, b = this.popover; this.setPosition();
            b.fadeIn(function () { b.data("visible", !0); setTimeout(function () { b.fadeOut(function () { b.data("visible", !1) }) }, a.popoverTimeout) })
        }, _destroy: function () { }, _setOption: function (a, b) { this._super("_setOption", a, b) }
    })
})(jQuery); (function (c) {
